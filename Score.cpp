...
Score::Score() {
	//ライブラリ、画像読み込み
	g_highscore = LoadGraph("highscore.png");
	g_score = LoadGraph("score.png");
	g_graze = LoadGraph("b_graze.png");
	g_hp = LoadGraph("HP.png");
	g_power = LoadGraph("power.png");
	LoadDivGraph("number.png",10,10,1,17,29,g_number);
